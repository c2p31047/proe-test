...
L.Control.OSMGeocoder = L.Control.extend({
	...
	onAdd: function (map) {
		...
		if (this.options.collapsed) {
			L.DomEvent.addListener(container, 'mouseclick', this._expand, this);
			L.DomEvent.addListener(container, 'mouseclick', this._collapse, this);
	...
	_createSearchResult : function(lat, lon) {
		//creates a position description similar to the result of a Nominatim search
		var diff = 0.005;
		var result = [];
		result[0] = {};
